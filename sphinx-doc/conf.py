...
# MFD OSD Control documentation build configuration file, created by
...
htmlhelp_basename = "mfd_osd_control"
...
man_pages = [(master_doc, "mfd_osd_control", "MFD OSD Control Documentation", [author], 1)]
